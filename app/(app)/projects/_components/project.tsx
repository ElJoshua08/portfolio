...
import { ExpandIcon, SquareArrowOutUpRightIcon } from "lucide-react";
  ...
  return (
    <div className="flex flex-row items-start justify-center gap-x-12 w-full h-96">
      <Dialog>
        <DialogTrigger className="cursor-pointer group relative h-full w-full">
          <div className="relative h-full aspect-19/10">
            <Image
              src={project.images.thumbnails.desktop}
              alt={project.title}
              fill
      ...
      <div className="flex flex-col items-start justify-between gap-y-12 w-full min-h-full ">
        ...
        <div className="flex flex-row items-center justify-center gap-x-4 mt-auto">
          <Tooltip>
            <TooltipTrigger asChild>
              ...
              >
                <a
                  ...
                  target="_blank"
                >
                  <GithubIcon className="fill-white size-7 group-hover:fill-accent" />
                </a>
              </Button>
            </TooltipTrigger>
            <TooltipContent>
